...
# Funkcja do monitorowania zużycia energii w Windowsie
def get_power_usage():
    try:
        # Używamy powercfg do uzyskania raportu o stanie systemu energetycznego
        result = subprocess.run(['powercfg', '/batteryreport'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
